# Generated by Django 4.2.29 on 2026-04-02 10:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='page',
            name='is_published',
            field=models.BooleanField(default=False, help_text='This camp will need to be marketfor the page to be publicly exhibited.'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_published', models.BooleanField(default=False, help_text='This camp will need to be marketfor the page to be publicly exhibited.')),
                ('content', models.TextField()),
                ('cover', models.ImageField(blank=True, default='', upload_to='posts/%Y/%m/')),
                ('cover_in_post_content', models.BooleanField(default=True, help_text='If market, it will exhibit the cover of the post.')),
